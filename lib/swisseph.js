...
swisseph.SE_ECL_1ST_VISIBLE = 512;
swisseph.SE_ECL_2ND_VISIBLE = 1024;
swisseph.SE_ECL_3RD_VISIBLE = 2048;
swisseph.SE_ECL_4TH_VISIBLE = 4096;
 ...
 */
swisseph.SE_TIDAL_DE200 = (-23.8946)
swisseph.SE_TIDAL_DE403 = (-25.580)  /* was (-25.8) until V. 1.76.2 */
swisseph.SE_TIDAL_DE404 = (-25.580)  /* was (-25.8) until V. 1.76.2 */
swisseph.SE_TIDAL_DE405 = (-25.826)  /* was (-25.7376) until V. 1.76.2 */
swisseph.SE_TIDAL_DE406 = (-25.826)  /* was (-25.7376) until V. 1.76.2 */
swisseph.SE_TIDAL_DE421 = (-25.85)   /* JPL Interoffice Memorandum 14-mar-2008 on DE421 Lunar Orbit */
swisseph.SE_TIDAL_DE422 = (-25.85)   /* JPL Interoffice Memorandum 14-mar-2008 on DE421 (sic!) Lunar Orbit */
swisseph.SE_TIDAL_DE430 = (-25.82)   /* JPL Interoffice Memorandum 9-jul-2013 on DE430 Lunar Orbit */
swisseph.SE_TIDAL_DE431 = (-25.80)   /* IPN Progress Report 42-196 • February 15, 2014, p. 15; was (-25.82) in V. 2.00.00 */
swisseph.SE_TIDAL_26 = (-26.0)
swisseph.SE_TIDAL_STEPHENSON_2016 = (-25.85)
swisseph.SE_TIDAL_DEFAULT = swisseph.SE_TIDAL_DE431
swisseph.SE_TIDAL_AUTOMATIC = 999999
swisseph.SE_TIDAL_MOSEPH = swisseph.SE_TIDAL_DE404
swisseph.SE_TIDAL_SWIEPH = swisseph.SE_TIDAL_DEFAULT
swisseph.SE_TIDAL_JPLEPH = swisseph.SE_TIDAL_DEFAULT

/* for function swe_set_delta_t_userdef() */
swisseph.SE_DELTAT_AUTOMATIC = (-1E-10)

swisseph.SE_MODEL_DELTAT = 0
swisseph.SE_MODEL_PREC_LONGTERM = 1
swisseph.SE_MODEL_PREC_SHORTTERM = 2
swisseph.SE_MODEL_NUT = 3
swisseph.SE_MODEL_BIAS = 4
swisseph.SE_MODEL_JPLHOR_MODE = 5
swisseph.SE_MODEL_JPLHORA_MODE = 6
swisseph.SE_MODEL_SIDT = 7
swisseph.NSE_MODELS = 8

/* precession models */
swisseph.SEMOD_NPREC = 9
swisseph.SEMOD_PREC_IAU_1976 = 1
swisseph.SEMOD_PREC_LASKAR_1986 = 2
swisseph.SEMOD_PREC_WILL_EPS_LASK = 3
swisseph.SEMOD_PREC_WILLIAMS_1994 = 4
swisseph.SEMOD_PREC_SIMON_1994 = 5
swisseph.SEMOD_PREC_IAU_2000 = 6
swisseph.SEMOD_PREC_BRETAGNON_2003 = 7
swisseph.SEMOD_PREC_IAU_2006 = 8
swisseph.SEMOD_PREC_VONDRAK_2011 = 9
swisseph.SEMOD_PREC_DEFAULT = swisseph.SEMOD_PREC_VONDRAK_2011
 ...
 */
swisseph.SEMOD_PREC_DEFAULT_SHORT = swisseph.SEMOD_PREC_VONDRAK_2011

/* nutation models */
swisseph.SEMOD_NNUT = 4
swisseph.SEMOD_NUT_IAU_1980 = 1
swisseph.SEMOD_NUT_IAU_CORR_1987 = 2 /* Herring's (1987) corrections to IAU 1980 
				    * nutation series. AA (1996) neglects them.*/
swisseph.SEMOD_NUT_IAU_2000A = 3 /* very time consuming ! */
swisseph.SEMOD_NUT_IAU_2000B = 4 /* fast, but precision of milli-arcsec */
swisseph.SEMOD_NUT_DEFAULT = swisseph.SEMOD_NUT_IAU_2000B  /* fast, but precision of milli-arcsec */

/* methods for sidereal time */
swisseph.SEMOD_NSIDT = 4
swisseph.SEMOD_SIDT_IAU_1976 = 1
swisseph.SEMOD_SIDT_IAU_2006 = 2
swisseph.SEMOD_SIDT_IERS_CONV_2010 = 3
swisseph.SEMOD_SIDT_LONGTERM = 4
swisseph.SEMOD_SIDT_DEFAULT = swisseph.SEMOD_SIDT_LONGTERM
//swisseph.SEMOD_SIDT_DEFAULT          SEMOD_SIDT_IERS_CONV_2010

/* frame bias methods */
swisseph.SEMOD_NBIAS = 3
swisseph.SEMOD_BIAS_NONE = 1  /* ignore frame bias */
swisseph.SEMOD_BIAS_IAU2000 = 2  /* use frame bias matrix IAU 2000 */
swisseph.SEMOD_BIAS_IAU2006 = 3  /* use frame bias matrix IAU 2006 */
swisseph.SEMOD_BIAS_DEFAULT = swisseph.SEMOD_BIAS_IAU2006

/* methods of JPL Horizons (iflag & SEFLG_JPLHOR), 
 * using daily dpsi, deps;  see explanations below */
swisseph.SEMOD_NJPLHOR = 2
swisseph.SEMOD_JPLHOR_LONG_AGREEMENT = 1  /* daily dpsi and deps from file are 
                                     * limited to 1962 - today. JPL uses the
				     * first and last value for all  dates 
				     * beyond this time range. */
swisseph.SEMOD_JPLHOR_BEFORE_1962_USE_APPROX = 2
                                    /* outside the available time range 
                                     * 1962 - today default to SEFLG_JPLHOR_APROX */
swisseph.SEMOD_JPLHOR_DEFAULT = swisseph.SEMOD_JPLHOR_LONG_AGREEMENT
...
swisseph.SEMOD_NJPLHORA = 2
swisseph.SEMOD_JPLHORA_1 = 1
swisseph.SEMOD_JPLHORA_2 = 2
swisseph.SEMOD_JPLHORA_DEFAULT = swisseph.SEMOD_JPLHORA_1
...
swisseph.SEMOD_NDELTAT = 5
swisseph.SEMOD_DELTAT_STEPHENSON_MORRISON_1984 = 1
swisseph.SEMOD_DELTAT_STEPHENSON_1997 = 2
swisseph.SEMOD_DELTAT_STEPHENSON_MORRISON_2004 = 3
swisseph.SEMOD_DELTAT_ESPENAK_MEEUS_2006 = 4
swisseph.SEMOD_DELTAT_STEPHENSON_ETC_2016 = 5
//swisseph.SEMOD_DELTAT_DEFAULT   SEMOD_DELTAT_ESPENAK_MEEUS_2006
swisseph.SEMOD_DELTAT_DEFAULT = swisseph.SEMOD_DELTAT_STEPHENSON_ETC_2016
